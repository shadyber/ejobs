                ...
                <div class="tab-content">
                  ...
                  <div class="post">
                      <div class="user-block">
                        ...
                        <span class="description">{{$job->title}} - {{$job->created_at}}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                      {{$job->detail}}
                    ...
                    <form action="/profile" method="post" enctype="multipart/form-data">
                     @csrf
                      ...
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="avatar">Choose Your Best photo</label>
                      </div>
                      <div class="input-group-append">
                        <span class="" id=""> <button class="input-group-text" type="submit">Submit</button></span>
                      </div>
                    </div>
